jQuery(function ($) {
    ...
    function buildModalItemMarkup(item) {
        return [
            ...
            '<a href="#" data-cart-remove="', escapeAttribute(item.key), '" title="Remove item" aria-label="Remove item"><i class="icofont-ui-delete" aria-hidden="true"></i></a>',
            "</div>",
            "</div>",
            "</div>",
            "</div>",
    ...
    function buildCartTableRow(item) {
        ...
        return [
            ...
            '<td class="cancel"><a href="#" class="cart-remove-item" data-cart-remove="', escapeAttribute(item.key), '" title="Remove item" aria-label="Remove item"><i class="flaticon-cancel" aria-hidden="true"></i></a></td>',
            "<td>",
            ...
            '<button class="qu-btn dec" data-cart-key="', escapeAttribute(item.key), '" title="Decrease quantity" aria-label="Decrease quantity">-</button>',
            '<input type="text" class="qu-input" data-cart-key="', escapeAttribute(item.key), '" value="', escapeAttribute(String(item.quantity)), '">',
            '<button class="qu-btn inc" data-cart-key="', escapeAttribute(item.key), '" title="Increase quantity" aria-label="Increase quantity">+</button>',
            "</div>",
            "</td>",
    ...
    function extractCartPayloadFromElement(element, quantity, optionLabel, selectedAddOns, overridePrice) {
        ...
        return {
            ...
            image: String(element.attr("data-cart-image") || "assets/images/amalaa.png").trim() || "assets/images/amalaa.png",
